	...
	while($d = mysql_fetch_object($r)){
		...
		if($d->status != 'c' and $visor < 7){
			...
			$TickDetalhe[] = "
				...
				"<div style='float:left; width:50%;'>".(($d->funcionario)?"<b>Funcionário:</b><div class='detalhesTexto' style='overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 1;'>".utf8_encode($d->funcionario)."</div>":false)."</div>".
