	...
	while($d = mysql_fetch_object($r)){
		...
		if($d->status != 'c'){
			...
			$TickDetalhe[] = "
					...
					"<div style='float:left; width:65%;'> <b>Setor:</b><div >".utf8_encode($d->setor_nome)."</div></div>".
					"<div style='float:left; width:35%;'> <b>Máquina:<span style='color:".(($d->parada == 's')?'red':'#333').";'> (".$parada[$d->parada].")</span></b><div >".utf8_encode($d->maquina_nome)."</div></div>".
