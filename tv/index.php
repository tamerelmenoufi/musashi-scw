<?php
	...
	while($d = mysql_fetch_object($r)){
        ...
        $TickDetalhe[] = "
				...
				"<div style='float:left; width:33%;'> <b style='color:#a1a1a1; font-size:10px;'>Máquina:</b><div>".utf8_encode($d->maquina)."</div></div>".
				"<div style='float:left; width:33%;'>".(($d->status)?"<b style='color:#a1a1a1; font-size:10px;'>Situação:</b><div>".$titulo[$d->status]."</div>":false)."</div>".
