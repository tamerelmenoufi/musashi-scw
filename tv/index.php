...
<div class="corpoTV">
	...
	<div class="slider-for statusDestaque">
		...
		?>
		<div style="position:absolute !important; left:0 !important; top:0 !important; bottom:0 !important; right:0 !important; opacity:0.5; background-color:<?=$CorDetalhe[$i]?>"><?=$TickDetalhe[$i]?></div>
		<?php
		}
		?>
	</div>
...
<div class="rodapeTV">
	...
	<div class="slider-nav">
		...
		?>
		<div style="border:solid 1px #ccc; margin:5px; padding:10px; text-align:center; border-radius:10px; opacity:0.5; background-color:<?=$CorResumo[$i]?>"><?=$TickResumo[$i]?></div>
		<?php
		}
		?>
	</div>
