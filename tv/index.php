	...
	while($d = mysql_fetch_object($r)){
        ...
        $TickDetalhe[] = "
				...
				"<div style='float:left; width:33%;'>".(($d->status)?"<b style='color:#a1a1a1; font-size:10px;'>Situação:</b>
					<div style='color:{$cor[$d->status]}; font-weight:bold;'>".$titulo[$d->status]."<span style='color:".(($d->status == 's')?'red':'green')."; font-weight:bold;'> (".$titulo[$d->status].")</span></div>":false)."</div>".
