...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        dragSettings: {},
        indicatorNew: '<i class="fa fa-hand-pointer-o" aria-hidden="true"></i>',
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    </div>\n' +
        '    <div area_imagens class="clearfix"  >  </div>' +
        '    <div class="file-preview-status text-center text-success"></div>\n' +
        //'    <div bloquear class="kv-fileinput-error">  </div>\n' +
        '    </div>\n' +
        '</div>';
    ...
    tBtnDefault = '<button remove_todos type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>';
    tBtnLink = '<a baixar href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label} </a>';
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '</div>';
    tActionDelete = '<button id="{caption}" onclick="remover(this.id)" type="button" class="kv-file-remove {removeClass}" ' +
    ...
    tImage = '<img imagens src="{data}" class="kv-preview-data file-preview-image" title="{caption}" alt="{caption}" ' +
        STYLE_SETTING + '>  \n  ' ;
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadIcon: '<i class="fa fa-floppy-o" aria-hidden="true"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneTitle: 'Arraste as imagens aqui &hellip;',
